...
drop table if exists public.hype_pitch_votes cascade;
drop table if exists public.hype_pitch_cooldowns cascade;
drop table if exists public.hype_pitches cascade;
